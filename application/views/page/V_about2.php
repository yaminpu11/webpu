    ...
    >
      ...
      <!-- <nav class="ampstart-sidebar-nav ampstart-nav">
        <ul class="list-reset m0 p0 ampstart-label">
          ...
          >
            <a class="ampstart-nav-link" href="mailto:contact@lune.com"
              >contact@lune.com</a
            >
          </li>
        </ul>
    ...
    <main role="main" class="lune-overlay">
      ...
      >
        <figure class="lune-overlay-hero-image absolute left-0 m0 col-12">
          ...
          <amp-img
            alt="Natural Oak"
            srcset="../img/lune/MRK.webp, ../img/lune/overlay-oak-hero-mobile@2x.webp 2x"
            layout="responsive"
            width="1250"
            height="2135"
          ...
          <amp-img
            alt="Natural Oak"
            srcset="../img/lune/overlay-oak-hero@1x.webp, ../img/lune/overlay-oak-hero@2x.webp 2x"
            layout="responsive"
            width="2000"
            height="1800"
          ...
          >
            ...
            <amp-img
              fallback=""
              alt="Natural Oak"
              srcset="../img/lune/overlay-oak-hero@1x.png, ../img/lune/overlay-oak-hero@2x.png 2x"
              layout="responsive"
              width="2000"
              height="1800"
            ></amp-img>
        ...
        <div class="relative z1 center">
          ...
          >
            <span class="relative block z3">Online Registration</span>
          </a>
        </div>
      </header>
      ...
      >
        ...
        <div class="lune-overlay-copy relative col-12 md-col-4 z1">
          <h2
            ...
            aria-label="Sustainably-grown Portugese natural oak"
          >
            <span class="lune-split-title-mobile lune-split-title-desktop"
              >Podomoro University</span
            >
      ...
      >
        ...
        >
          ...
          <amp-img
            alt="Oak"
            srcset="../assets/img/about/MRK.webp, ../assets/img/about/MRK.webp 2x"
            layout="responsive"
            width="1200"
            height="1340"
            media="(min-width: 720px)"
          >
            ...
            <amp-img
              fallback=""
              alt="Oak"
              srcset="../assets/img/about/MRK.jpg, ../assets/img/about/MRK.jpg 2x"
              layout="responsive"
              width="1200"
              height="1340"
            ></amp-img>
        ...
        <div class="lune-overlay-copy relative col-12 md-col-4 lg-col-3 mt2 z1">
          ...
          >
            ...
            <ul>
              ...
              <li>Membangun kebanggaan dan keunggulan atas Universitas</li>
              <li>Menyelenggarakan pengendalian mutu proses pembelajaran yang mengacu pada standar internasional</li>
              <li>Menghasilkan lulusan berjiwa kewirausahaan yang memiliki kompetensi terhadap ilmu pengetahuan dan teknologi serta berbudaya Indonesia</li>
            </ul>
